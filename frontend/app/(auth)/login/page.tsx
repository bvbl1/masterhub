  ...
  return (
    <div className="flex min-h-dvh h-full w-full max-w-[1539px] mx-auto flex-col md:flex-row items-stretch justify-center md:justify-center md:py-4 md:px-2">
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="flex w-full md:w-1/2 md:max-w-[50%] shrink-0 items-center justify-center px-4 py-8 sm:px-6 sm:pb-24 md:pr-10 md:py-4 order-2 md:order-0"
      >
        <motion.div
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="hidden md:flex md:w-[50%] shrink-0 md:min-h-[min(560px,calc(100dvh-2rem))]"
      >
        <div className="relative w-full flex-1 min-h-[min(560px,calc(100dvh-2rem))] overflow-hidden md:rounded-l-4xl md:shadow-2xl md:shadow-slate-300/40">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#486284]/40 via-transparent to-transparent" />
          <motion.div
